...
@interface DynamicViewController ()<UITableViewDelegate,UITableViewDataSource,DynamicTableViewCellDelegate>
{
...
-(void)rightBtnAction{
    ...
    announceDynamicVC.isDynamic = YES;
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
     NSLog(@"%ld .........%f", (long)indexPath.row,cellHeight);
    return cellHeight;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    DynamicTableViewCell *dynamicCell = [tableView dequeueReusableCellWithIdentifier:@"dynamicCell" forIndexPath:indexPath];
